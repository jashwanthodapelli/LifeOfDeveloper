...
An immersive, scroll-driven storytelling website that takes you through the real, relatable, and hilariously painful journey of being a developer — from the first "Hello World" to hitting deploy at 3 AM.

---

## 🌐 Live Demo

Open `index.html` in any modern browser — no build step, no dependencies, no npm install required.
